...
class HitboxTest {
    ...
    void collidesWithCircles() {
        final Hitbox circleHtibox1 = new HitboxImpl(new PairImpl<>(1.2f, 3.2f), 4.0f);
        final Hitbox circleHtibox2 = new HitboxImpl(new PairImpl<>(7.2f, -1.15f), 6.0f);
        final Hitbox circleHtibox3 = new HitboxImpl(new PairImpl<>(12.7f, 4.0f), 2.0f);
    ...
    void collidesWithRectangles() {
        final Hitbox rectangleHtibox1 = new HitboxImpl(new PairImpl<>(4.2f, 5.7f), new PairImpl<>(4.7f, 4.2f));
        final Hitbox rectangleHtibox2 = new HitboxImpl(new PairImpl<>(9.0f, 0.0f), new PairImpl<>(2.4f, 5.0f));
        final Hitbox rectangleHtibox3 = new HitboxImpl(new PairImpl<>(5.0f, 2.0f), new PairImpl<>(10.0f, 4.0f));
